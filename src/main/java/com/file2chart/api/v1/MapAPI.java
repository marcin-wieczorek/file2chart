...
@Tag(name = "Map", description = "Interactive (html) or static (image) map based on source file")
@RequestMapping("/v1")
public interface MapAPI {
    ...
    @PostMapping(value = "/map/visualization/embedded", consumes = MediaType.APPLICATION_JSON_VALUE, produces = {MediaType.TEXT_HTML_VALUE, MediaType.APPLICATION_JSON_VALUE})
    String generateEmbeddedMapVisualization(@Valid @RequestBody EmbeddedMapVisualizationRequest input, Model model, HttpServletRequest request);
    ...
    @PostMapping(value = "/map/visualization/image", consumes = MediaType.APPLICATION_JSON_VALUE, produces = {MediaType.APPLICATION_OCTET_STREAM_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<InputStreamResource> generateImageMapVisualization(@Valid @RequestBody ImageMapVisualizationRequest input, Model model, HttpServletRequest request);
}
